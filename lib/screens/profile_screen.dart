  ...
  Widget build(BuildContext context) {
    const sections = <(String, String)>[
      ...
      (
        ...
        'قد نجمع الاسم، البريد الإلكتروني، رقم الهاتف، بيانات الملف الشخصي، العنوان، بيانات الطلبات والسلة والنقاط والقسائم المرتبطة بحسابك.',
      ),
      (
      ...
      (
        'حقوق المستخدم',
        'يمكنك طلب الاطلاع على بيانات حسابك أو تصحيحها أو طلب حذفها، مع مراعاة المتطلبات القانونية والاحتفاظ بسجلات المعاملات عند الحاجة.',
      ),
      (
        'بيانات الأطفال',
