...
import '../services/taxi_driver_application_service.dart';
import '../theme/app_theme.dart';
import 'authentication_screen.dart';

class TaxiDriverRegistrationScreen extends StatefulWidget {
  const TaxiDriverRegistrationScreen({super.key});

  @override
  State<TaxiDriverRegistrationScreen> createState() =>
      _TaxiDriverRegistrationScreenState();
}

class _TaxiDriverRegistrationScreenState
    extends State<TaxiDriverRegistrationScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      await TaxiDriverApplicationService().apply(
          ...
          child: ListView(
            ...
            children: [
              ...
              TextFormField(
                ...
                validator: _required,
                decoration: const InputDecoration(
                  labelText: 'نوع السيارة ورقم اللوحة',
              ...
              CheckboxListTile(
                ...
                title: const Text(
                  'قرأت وأوافق على شروط سائق تكسي بركة',
                  style: TextStyle(
                    fontWeight: FontWeight.w800,
                  ),
                ),
              ...
              const SizedBox(height: 14),
              const Text(
                'لن يتم تفعيل سائق التكسي أو ربطه بمكتب تكسي إلا بعد مراجعة الأدمن للبيانات والوثائق المطلوبة.',
                textAlign: TextAlign.center,
                style: TextStyle(
